    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-900">
      ...
      <div className="w-full max-w-md space-y-8 p-8 bg-zinc-800 rounded-xl shadow-lg">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-extrabold text-zinc-100">Create your account</h2>
        </div>
          ...
          <div>
            {
              ...
              >
               <span className="mr-2 animate-spin"><LoaderCircle size={18}/> </span>please wait
              </Button>:<Button
              type="submit"
        ...
        <div className="text-sm text-center">
          <Link href="/signin" className="font-medium text-zinc-300 hover:text-zinc-100">
